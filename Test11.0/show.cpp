        ...
        while (HP > 0)
        {
            ...
            for (int i = 0; i < Xhz_number; i++)
            {
                ...
                if (xhz[i].hp <= 0)
                {
                    ...
                    xhz[i].speed = (Xhz_speed + (mark / 80) > Xhz_speed_max ? Xhz_speed_max : Xhz_speed + (mark / 80));
                    xhz[i].atk = ((Xhz_atk + ((float)mark / 1000)) > Xhz_atk_max ? Xhz_atk_max : (Xhz_atk + ((float)mark / 1000)));
                    if (qixue)
                    {
                        HP += 0.1;
                    }
