...
const float constHP = 3;//人物初始血量
const int Attack = 10;//人物初始攻击力
const int Xhz_number = 10;//小黑子数量
const int Xhz_atk = 1;//小黑子攻击力
const int Xhz_atk_max = 3;//小黑子最大攻击力
const int Xhz_speed = 5;//小黑子初始速度
const int Xhz_speed_max = 20;//小黑子最大速度
...
void drawxhz(int real_xhz_x, int real_xhz_y, int camera_x, int camera_y, IMAGE* xhz)
{
	...
	if (xhz_x >= 0 && xhz_x <= WIDTH - 60 && xhz_y >= 0 && xhz_y <= HEIGHT - 60)
	{
